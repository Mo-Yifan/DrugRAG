...
class Settings(BaseSettings):
    ...
    # 通用设置
    # ======================
    PROJECT_NAME: str = "DrugBank Clinical RAG"
    API_V1_STR: str = "/api"
    ...
    # 向量数据库 (Chroma)
    # ======================
    CHROMA_COLLECTION: str = Field(default="drugbank_rag", env="CHROMA_COLLECTION")
    CHROMA_PERSIST_DIR: Path = Field(
        default_factory=lambda: Path(os.getenv("CHROMA_PERSIST_DIR", "./artifacts/vectors/chroma"))
    )
